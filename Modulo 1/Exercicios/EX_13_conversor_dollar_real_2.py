...
if opcao == 1:
    ...
    qtd_dollar = float(input('Informe a quantidade de dólares:'))
    print(f'O valor em reais é R$ {dollar*qtd_dollar}')
elif opcao == 2:
    dollar_2 = float(input('Informe a cotação atual do Dollar:'))
    qtd_reais = float(input('Informe a quantidade de reais:'))
    print(f'O valor em reais é R$ {qtd_reais/dollar_2}')
else:
